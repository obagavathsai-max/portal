...
test.describe('Portal Branding and Data Verification', () => {
  test.beforeEach(async ({ page }) => {
    ...
    // Standardize IDs used in Login.tsx
  ...
  test('Check Attendance Branding and Data', async ({ page }) => {
    // Navigate to Attendance via link
    // The sidebar categories might need to be expanded first, but 'Exam Scores' is what we want.
    // 'Personal' is expanded by default in Layout.tsx.
