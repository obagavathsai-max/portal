            ...
            <div className="relative ml-1">
              ...
              {userMenuOpen && (
                <>
                  ...
                  />
                  <div className="absolute right-0 mt-1 w-48 bg-white rounded shadow-xl z-50 py-1 overflow-hidden border border-gray-100">
                    <button
                      className="w-full flex items-center gap-3 px-4 py-2 text-sm text-gray-700 hover:bg-aums-bg-main"
                    ...
                    <div className="bg-aums-pink py-0.5">
                      {item.children.map((child) => (
                        <NavLink
                          ...
                          to={child.path}
                          className={({ isActive }) =>
                            `flex items-center gap-3 pl-3 pr-3 py-2.5 text-[12px] font-medium transition-colors ${isActive ? 'text-white font-bold' : 'text-white hover:bg-black/10'
                            }`
                          }
                          onClick={() => setSidebarOpen(false)}
                        >
