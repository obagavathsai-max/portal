    ...
    <div className="min-h-screen flex flex-col font-sans bg-aums-bg-main">
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        >
              ...
              return (
                <div key={item.name} className="relative">
                  <button
                    ...
                    className={`w-full flex items-center justify-between px-3 py-2.5 text-[13px] font-medium transition-colors text-white ${isExpanded ? 'bg-aums-sidebar-active' : 'hover:bg-aums-orange-dark'}`}
                  >
                  ...
                  {isExpanded && item.children && (
                    <div className="bg-aums-sidebar-active py-0.5">
          ...
          <div className="p-4 mt-auto bg-aums-orange">
