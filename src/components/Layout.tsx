      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <aside
          className={`
            ...
            lg:translate-x-0 lg:static lg:top-0 lg:h-auto bg-aums-orange
          `}
        >
          <div className="flex items-center justify-end p-2 px-3">
            <button className="p-1 rounded-sm shadow-inner bg-aums-orange-dark" onClick={() => setSidebarOpen(false)}>
              ...
              return (
                <div key={item.name} className="relative">
                  <button
                    ...
                    className={`w-full flex items-center justify-between px-3 py-2.5 text-[13px] font-medium transition-colors text-white ${isExpanded ? 'bg-aums-pink-red' : 'hover:bg-black/10'}`}
                  >
                  ...
                  {isExpanded && item.children && (
                    <div className="bg-aums-pink-red py-0.5">
