      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        >
          <div className="flex items-center justify-end p-2 px-3">
            <button className="bg-[var(--color-aums-orange-accent)] p-1 rounded-sm shadow-inner" onClick={() => setSidebarOpen(false)}>
              ...
              return (
                <div key={item.name} className="relative">
                  <button
                    ...
                    className={`w-full flex items-center justify-between px-3 py-2.5 text-[13px] font-medium transition-colors text-white ${isExpanded ? 'bg-[var(--color-aums-pink-red)]' : 'hover:bg-[var(--color-aums-orange-dark)]'}`}
                  >
