  ...
  return (
    <div className="min-h-screen flex flex-col font-sans bg-aums-bg-main">
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <aside
          className={`
            fixed top-14 bottom-0 left-0 z-40 w-[180px] shadow-lg flex flex-col bg-aums-orange
              ...
              return (
                <div key={item.name} className="relative">
                  <button
                    ...
                    className={`w-full flex items-center justify-between px-3 py-2.5 text-[13px] font-medium transition-colors text-white ${isExpanded ? 'bg-aums-pink-red' : 'hover:bg-aums-orange-dark'}`}
                  >
