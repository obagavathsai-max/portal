...
import { ChevronDown, Link as LinkIcon, HelpCircle, Maximize2, Star, Home } from 'lucide-react';
                    ...
                    {cell !== null ? (
                      <span
                        className={`inline-flex items-center justify-center w-6 h-6 rounded-sm text-xs cursor-pointer
                          ...
                          ${!isToday(cell) && (isFri || isSat) ? 'text-aums-teal' : !isToday(cell) ? 'text-gray-800' : ''}
                        `}
                      >
                        {cell}
                      </span>
