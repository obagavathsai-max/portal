  ...
  return (
    <div className="text-xs">
      <div className="flex items-center justify-between mb-2">
        <span className="font-bold text-sm" style={{ color: 'var(--color-aums-teal)' }}>{monthName}</span>
    ...
    <div className="space-y-4">
      ...
      <div className="flex flex-wrap gap-2 pt-2">
        ...
        {courseTabs.map((tab, i) => (
          <button
            key={i}
            className="flex items-center gap-1.5 px-4 py-2 rounded-full text-[12px] font-semibold shadow-sm text-gray-700 transition-colors hover:bg-[var(--color-aums-teal-hover)] group active:scale-95"
            style={{ backgroundColor: 'var(--color-aums-teal-light)' }}
          >
            ...
            <ChevronDown size={14} className="shrink-0 text-[var(--color-aums-teal)]/60 group-hover:text-[var(--color-aums-teal)]" />
          </button>
        ))}
      </div>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-12 gap-5">
        ...
        <div className="xl:col-span-8 bg-white border border-gray-200 rounded-sm shadow-sm overflow-hidden">
          <div className="flex items-center justify-between px-4 py-2 border-b border-gray-200" style={{ backgroundColor: 'var(--color-aums-teal-light)' }}>
