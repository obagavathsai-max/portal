...
import { ChevronDown, ChevronUp, Link as LinkIcon, HelpCircle, Maximize2, Star, Home as HomeIcon, Menu } from 'lucide-react';
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex flex-wrap gap-2 pt-2">
        ...
        >
          <HomeIcon size={13} className="text-white" /> Home <ChevronDown size={14} className="text-white/70" />
        </button>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-12 gap-5">
        ...
        <div className="xl:col-span-8 bg-white border border-gray-200 rounded-sm shadow-sm overflow-hidden">
          ...
          <div className="p-5">
            ...
            <div className="space-y-4">
              <p className="font-bold text-[18px] text-aums-pink-red">Om Amriteswaryai Namah</p>
              ...
              <div className="pt-2">
                <p className="text-[14px] font-bold text-aums-pink-red">Chancellor,</p>
                <p className="text-[14px] font-bold text-aums-pink-red">Sri Mata Amritanandamayi Devi</p>
              </div>
            </div>
          </div>
        </div>
