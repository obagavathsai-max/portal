      ...
      <div className="grid grid-cols-1 xl:grid-cols-12 gap-5">
        ...
        <div className="xl:col-span-8 bg-white border border-gray-200 rounded-sm shadow-sm overflow-hidden">
          ...
          <div className="p-5">
            ...
            <div className="space-y-4">
              <p className="font-bold text-[18px] text-[#e91e63]">Om Amriteswaryai Namah</p>
              ...
              <div className="pt-2">
                <p className="text-[14px] font-bold text-[#e91e63]">Chancellor,</p>
                <p className="text-[14px] font-bold text-[#e91e63]">Sri Mata Amritanandamayi Devi</p>
              </div>
            </div>
          </div>
        </div>
