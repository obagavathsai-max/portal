                    ...
                    {cell !== null ? (
                      <span
                        className={`inline-flex items-center justify-center w-6 h-6 rounded-sm text-xs cursor-pointer
                          ${isToday(cell) ? 'font-bold bg-aums-yellow-highlight border border-aums-yellow-border' : ''}
                          ${!isToday(cell) && (isFri || isSat) ? 'text-aums-teal' : ''}
                          ${!isToday(cell) && !(isFri || isSat) ? 'text-gray-800' : ''}
                        `}
                      >
                        {cell}
                      </span>
  ...
  return (
    <div className="space-y-4 min-h-full">
      ...
      <div className="flex flex-wrap gap-2 pt-2">
        {/* Home tab */}
        <button
          className="flex items-center gap-1.5 px-4 py-2 rounded-full text-[12px] font-bold text-white shadow-sm transition-opacity hover:opacity-90 active:scale-95 bg-aums-teal"
        >
        ...
        {courseTabs.map((tab, i) => (
          <button
            key={i}
            className="flex items-center gap-1.5 px-4 py-2 rounded-full text-[12px] font-semibold shadow-sm text-gray-700 transition-colors hover:bg-aums-teal/20 group active:scale-95 bg-aums-teal-light"
          >
      ...
      <div className="flex items-center gap-2 mt-6 mb-3">
        ...
        <h2 className="text-[14px] font-bold uppercase tracking-wide text-aums-teal">Overview</h2>
      </div>
        ...
        <div className="xl:col-span-8 bg-white border border-gray-200 rounded-sm shadow-sm overflow-hidden">
          ...
          <div className="p-5">
            ...
            <div className="space-y-4">
              <p className="font-bold text-[18px] text-aums-pink">Om Amriteswaryai Namah</p>
              ...
              <div className="pt-2">
                <p className="text-[14px] font-bold text-aums-pink">Chancellor,</p>
                <p className="text-[14px] font-bold text-aums-pink">Sri Mata Amritanandamayi Devi</p>
              </div>
            </div>
          </div>
        </div>
