        ...
        <div className="p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-y-8 gap-x-12 mb-10">
            ...
            <div>
              ...
              <p className="text-[14px] font-medium uppercase text-gray-800">ORUGANTI BAGAVATH SAI</p>
            </div>
            <div>
              <p className="text-[13px] text-gray-600 mb-1">Academic Program</p>
              <p className="text-[14px] font-medium uppercase text-gray-800">B.Tech 2023</p>
            </div>
            <div>
