      ...
      <div className="bg-white border border-gray-200 rounded-sm shadow-sm overflow-hidden">
        ...
        <div className="p-6">
          ...
          <div className="flex flex-col md:flex-row items-end gap-4 max-w-4xl">
            ...
            <button
              onClick={handleSave}
              className="text-white px-6 py-2 rounded text-[13px] font-bold shadow-sm transition-colors mb-0.5 bg-[var(--color-aums-teal)] hover:bg-[var(--color-aums-teal-dark)]"
            >
              Save
            </button>
          </div>
