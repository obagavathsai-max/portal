        ...
        <div className="p-6">
          ...
          <div className="flex flex-col md:flex-row items-end gap-4 max-w-4xl">
            <div className="flex-1 w-full">
              <div className="relative border border-gray-300 rounded-md px-3 py-1 bg-[var(--color-aums-bg-alt)]">
            ...
            <button
              onClick={handleSave}
              className="bg-[var(--color-aums-teal)] hover:bg-[#1f8a80] text-white px-6 py-2 rounded text-[13px] font-bold shadow-sm transition-colors mb-0.5"
            >
              Save
            </button>
          </div>
