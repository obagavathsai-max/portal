...
export default function FeeDetails() {
  ...
  return (
    <div className="space-y-4 min-h-full bg-aums-bg-alt p-5 rounded-sm">
      <div className="bg-white border border-gray-200 rounded-sm shadow-sm">
        ...
        <div className="p-5">
          ...
          <div className="mb-6">
            <div className="inline-flex items-baseline border border-gray-300 rounded-sm focus-within:border-aums-teal transition-colors" style={{ minWidth: '260px' }}>
          ...
          <div className="overflow-x-auto border border-gray-200 rounded-sm">
            <table className="min-w-full text-sm">
              ...
              <tbody>
                <tr>
                  <td colSpan={6} className="px-4 py-8 text-center text-gray-500 text-sm bg-white">
