...
const semesters = [
  {
    ...
    subjects: [
      ...
      { code: '22AIE302', name: 'Formal language and Automata', credits: 3, type: 'Regular', grade: 'O' },
  ...
  },
  {
    ...
    subjects: [
      ...
      { code: '22AIE101', name: 'Problem Solving & C Programming', credits: 4, type: 'Regular', grade: 'O' },
