  ...
  return (
    <div className="space-y-4 bg-white min-h-[calc(100vh-120px)]">
      <div className="bg-white border border-gray-200 rounded-sm">
        <div className="px-4 py-3 border-b border-gray-100 bg-aums-teal-light">
        ...
        <div className="p-4">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-y-4 mb-6 text-[13px]">
            <div className="flex flex-col gap-1">
              <span className="text-gray-500 font-bold uppercase tracking-wider text-[10px]">Roll No</span>
              <span className="font-semibold text-gray-800">AV.SC.U4AIE23132</span>
            </div>
            <div className="flex flex-col gap-1">
              <span className="text-gray-500 font-bold uppercase tracking-wider text-[10px]">Name</span>
              <span className="font-semibold text-aums-teal uppercase">ORUGANTI BAGAVATH SAI</span>
            </div>
            <div className="flex flex-col gap-1">
              <span className="text-gray-500 font-bold uppercase tracking-wider text-[10px]">Academic Program & Branch</span>
              <span className="font-semibold text-gray-800 uppercase">B.Tech 2023 AIE</span>
            </div>
            <div className="flex flex-col gap-1">
              <span className="text-gray-500 font-bold uppercase tracking-wider text-[10px]">Current CGPA</span>
              <span className="font-semibold text-aums-teal font-bold text-lg">9.41</span>
            </div>
          </div>
          ...
          {showTable && (
            <div className="mt-6 overflow-x-auto border border-gray-300 rounded-sm">
              <table className="min-w-full text-[12px] border-collapse">
                <thead>
                  <tr className="bg-aums-teal text-white border-b border-gray-300">
                    <th className="px-3 py-2 text-left font-bold border-r border-white/10 uppercase tracking-wider">Sem</th>
                    <th className="px-3 py-2 text-left font-bold border-r border-white/10 uppercase tracking-wider">Course Code</th>
                    <th className="px-3 py-2 text-left font-bold border-r border-white/10 uppercase tracking-wider">Course Name</th>
                    <th className="px-3 py-2 text-left font-bold border-r border-white/10 uppercase tracking-wider">Academic Term Period</th>
                    <th className="px-3 py-2 text-left font-bold border-r border-white/10 uppercase tracking-wider">Type</th>
                    <th className="px-3 py-2 text-left font-bold uppercase tracking-wider">Grade</th>
                  </tr>
                </thead>
                <tbody>
                  {currentSem.subjects.map((subject, i) => (
                    <tr key={subject.code} className="border-b border-gray-300 hover:bg-gray-50 transition-colors">
                      <td className="px-3 py-2 border-r border-gray-300 text-gray-700 text-center font-bold">{currentSem.name}</td>
                      <td className="px-3 py-2 border-r border-gray-300 font-medium text-gray-700">{subject.code}</td>
                      <td className="px-3 py-2 border-r border-gray-300 text-gray-700">{subject.name}</td>
                      <td className="px-3 py-2 border-r border-gray-300 text-gray-700">{currentSem.term}</td>
                      <td className="px-3 py-2 border-r border-gray-300 text-gray-700">{subject.type}</td>
                      <td className="px-3 py-2 text-center font-bold text-gray-800">{subject.grade}</td>
                    </tr>
                  ))}
                  <tr className="bg-gray-50 font-bold">
                    <td colSpan={5} className="px-3 py-2 text-right border-r border-gray-300 uppercase text-gray-700">SGPA</td>
                    <td className="px-3 py-2 text-center text-aums-teal text-lg">{currentSem.sgpa}</td>
                  </tr>
                </tbody>
              </table>
            </div>
