...
const marksData = [
  { course: '22AIE311 Software Engineering', internal: '45/50', external: '42/50', total: '87/100' },
  { course: '22AIE312 Big Data Analytics', internal: '40/50', external: '38/50', total: '78/100' },
  { course: '22AIE313 Computer Vision', internal: '42/50', external: '40/50', total: '82/100' },
  { course: '22AIE314 Computer Security', internal: '38/50', external: '35/50', total: '73/100' },
  { course: '22AIE315 NLP', internal: '46/50', external: '44/50', total: '90/100' },
];
            ...
            <table className="w-full border-collapse text-sm">
              <thead>
                <tr className="bg-aums-bg-main text-gray-700">
                  ...
                  <th className="border border-gray-200 p-3 text-center">External</th>
              ...
              <tbody>
                {marksData.map((row, i) => (
                  <tr key={i}>
                    ...
                    <td className="border border-gray-200 p-3 text-center">{row.internal}</td>
                    <td className="border border-gray-200 p-3 text-center">{row.external}</td>
                    <td className="border border-gray-200 p-3 text-center font-bold text-aums-teal">{row.total}</td>
                  </tr>
                ))}
              </tbody>
            </table>
