              ...
              <table className="min-w-full text-[12px] border-collapse">
                <thead>
                  <tr className="bg-aums-teal text-white border-b border-gray-300">
                    ...
                    <th className="px-3 py-2 text-center font-bold border-r border-white/10 uppercase tracking-wider">Internal</th>
                    <th className="px-3 py-2 text-center font-bold border-r border-white/10 uppercase tracking-wider">External</th>
                    <th className="px-3 py-2 text-center font-bold uppercase tracking-wider">Total</th>
                  </tr>
                </thead>
                <tbody>
                  {mockMarks.map((mark, i) => (
                    <tr key={mark.code} className="border-b border-gray-300 hover:bg-gray-50 transition-colors">
                      <td className="px-3 py-2 border-r border-gray-300 font-medium text-gray-700">{mark.code}</td>
                      <td className="px-3 py-2 border-r border-gray-300 text-gray-700">{mark.name}</td>
                      <td className="px-3 py-2 border-r border-gray-300 text-center text-gray-700">{mark.internal}</td>
                      <td className="px-3 py-2 border-r border-gray-300 text-center text-gray-700">{mark.external}</td>
                      <td className="px-3 py-2 text-center font-bold text-aums-teal">{mark.total}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
