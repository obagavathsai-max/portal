...
export default function Attendance() {
  ...
  return (
    <div className="space-y-4" style={{ backgroundColor: 'var(--color-aums-bg-alt)', minHeight: 'calc(100vh - 120px)', padding: '20px' }}>
                    ...
                    data.map((row) => (
                      <tr key={row.slNo} className="bg-white">
                        ...
                        <td
                          ...
                          style={{ backgroundColor: 'var(--color-aums-red-error)' }}
                        >
                          {row.percentage}
                        </td>
