...
export default function Attendance() {
  ...
  return (
    <div className="space-y-4 min-h-full bg-aums-bg-main p-[20px]">
        ...
        <div className="p-5">
          ...
          <div className="flex gap-3 mb-6">
            <button
              ...
              className="px-5 py-2 text-white text-sm font-semibold rounded-sm hover:bg-aums-teal-dark transition-colors bg-aums-teal"
            >
              Attendance Summary
            </button>
            <button
