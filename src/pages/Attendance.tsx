...
export default function Attendance() {
  ...
  return (
    <div className="space-y-4 min-h-[calc(100vh-120px)] p-5 bg-[var(--color-aums-bg-main)]">
        ...
        <div className="p-5">
          ...
          <div className="flex gap-3 mb-6">
            <button
              ...
              className="px-5 py-2 text-white text-sm font-semibold rounded-sm hover:opacity-90 transition-opacity bg-[var(--color-aums-teal)]"
            >
              Attendance Summary
            </button>
            <button
          ...
          {showReport && (
            <div className="overflow-x-auto">
              <table className="w-full border-collapse border border-gray-200 text-xs">
                <thead>
                  <tr className="text-white bg-[var(--color-aums-teal)]">
                  ...
                  {data.length > 0 ? (
                    data.map((row) => (
                      <tr key={row.slNo} className="bg-white">
                        ...
                        <td
                          className="border border-gray-300 p-2 text-center font-semibold text-white bg-[var(--color-aums-red-error)]"
                        >
                          {row.percentage}
                        </td>
