...
export default function Signup() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-4 bg-aums-bg-login">
      ...
      {/* Signup Card - Matching Login Card Style */}
        ...
        <form onSubmit={handleSignup} className="space-y-6">
          <div className="relative">
            <input
              ...
              required
              className="w-full px-4 py-[18px] border-none rounded-[4px] text-[18px] placeholder-gray-500 focus:outline-none transition-all bg-aums-input-login"
            />
          </div>
