  ...
  return (
    <div className="space-y-4">
      <div className="bg-white border border-gray-200 rounded shadow-sm overflow-hidden">
        <div className="px-4 py-3 border-b border-gray-200 bg-[#e0f2f1]">
          <h1 className="font-bold text-sm uppercase tracking-wide text-[var(--color-aums-teal)]">
        ...
        <div className="p-6">
          ...
          <div className="flex items-center gap-4 mb-6 pb-4 border-b border-gray-100">
            <div
              className="w-16 h-16 rounded-full flex items-center justify-center text-white text-xl font-bold bg-[var(--color-aums-teal)]"
            >
              OB
            </div>
            <div>
              ...
              <p className="text-xs mt-1 text-[var(--color-aums-orange)]">{profile.program}</p>
            </div>
            <div className="ml-auto">
              {!isEditing ? (
                <button
                  onClick={() => setIsEditing(true)}
                  className="px-4 py-1.5 text-xs font-semibold text-white rounded bg-[var(--color-aums-teal)]"
                >
                  Edit Profile
                </button>
              ) : (
                <button
                  ...
                  className="px-4 py-1.5 text-xs font-semibold text-white rounded bg-[var(--color-aums-orange)]"
                >
                  Save Changes
                </button>
              )}
            ...
            {[
              ...
              <div key={field.key}>
                ...
                <input
                  ...
                  style={isEditing ? { borderColor: 'var(--color-aums-teal)' } : {}}
                />
              </div>
            ))}
          </div>
      ...
      <div className="bg-white border border-gray-200 rounded shadow-sm overflow-hidden">
        <div className="px-4 py-3 border-b border-gray-200 bg-[#e0f2f1]">
          <h2 className="font-bold text-sm uppercase tracking-wide text-[var(--color-aums-teal)]">Academic Summary</h2>
        </div>
        <div className="p-6">
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
            {[
              ...
              <div key={item.label} className="text-center p-3 border border-gray-100 rounded bg-gray-50">
                <p className="text-xl font-bold text-[var(--color-aums-teal)]">{item.value}</p>
