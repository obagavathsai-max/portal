            ...
            <div className="ml-auto">
              {!isEditing ? (
                <button
                  ...
                  className="px-4 py-1.5 text-xs font-semibold text-white rounded bg-aums-teal"
                >
                  Edit Profile
                </button>
              ) : (
                <button
                  ...
                  className="px-4 py-1.5 text-xs font-semibold text-white rounded bg-aums-orange"
                >
                  Save Changes
                </button>
              )}
            ...
            {[
              ...
              <div key={field.key}>
                ...
                <input
                  ...
                  disabled={!isEditing}
                  className={`w-full px-3 py-2 border rounded text-sm text-gray-700 bg-gray-50 disabled:opacity-80 focus:outline-none transition-colors ${isEditing ? 'border-aums-teal' : 'border-gray-300'}`}
                />
              </div>
            ))}
          </div>
