            ...
            {[
              ...
              <div key={field.key}>
                ...
                <input
                  ...
                  disabled={!isEditing}
                  className={`w-full px-3 py-2 border rounded text-sm text-gray-700 bg-gray-50 disabled:opacity-80 focus:outline-none transition-colors ${isEditing ? 'border-aums-teal focus:border-aums-teal-dark' : 'border-gray-300'}`}
                />
              </div>
            ))}
          </div>
