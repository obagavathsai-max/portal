  ...
  return (
    <div className="space-y-4">
      <div className="bg-white border border-gray-200 rounded shadow-sm overflow-hidden">
        <div className="px-4 py-3 border-b border-gray-200" style={{ backgroundColor: 'var(--color-aums-teal-light)' }}>
          <h1 className="font-bold text-sm uppercase tracking-wide" style={{ color: 'var(--color-aums-teal)' }}>
        ...
        <div className="p-6">
          ...
          <div className="flex items-center gap-4 mb-6 pb-4 border-b border-gray-100">
            ...
            <div>
              ...
              <p className="text-xs mt-1" style={{ color: 'var(--color-aums-orange)' }}>{profile.program}</p>
            </div>
      ...
      <div className="bg-white border border-gray-200 rounded shadow-sm overflow-hidden">
        <div className="px-4 py-3 border-b border-gray-200" style={{ backgroundColor: 'var(--color-aums-teal-light)' }}>
          <h2 className="font-bold text-sm uppercase tracking-wide" style={{ color: 'var(--color-aums-teal)' }}>Academic Summary</h2>
        </div>
        <div className="p-6">
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
            {[
              ...
              <div key={item.label} className="text-center p-3 border border-gray-100 rounded bg-gray-50">
                <p className="text-xl font-bold" style={{ color: 'var(--color-aums-teal)' }}>{item.value}</p>
