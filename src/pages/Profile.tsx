        ...
        <div className="p-6">
          ...
          <div className="flex items-center gap-4 mb-6 pb-4 border-b border-gray-100">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500 font-medium">{profile.rollNo}</p>
              <p className="text-xs mt-1 font-bold text-aums-orange">{profile.program}</p>
            </div>
            <div className="ml-auto">
              {!isEditing ? (
                <button
                  onClick={() => setIsEditing(true)}
                  className="px-4 py-1.5 text-xs font-bold text-white rounded uppercase tracking-wider bg-aums-teal hover:opacity-90 transition-opacity"
                >
                  Edit Profile
                </button>
              ) : (
                <button
                  ...
                  className="px-4 py-1.5 text-xs font-bold text-white rounded uppercase tracking-wider bg-aums-orange hover:opacity-90 transition-opacity"
                >
                  Save Changes
                </button>
              )}
            ...
            {[
              ...
              <div key={field.key}>
                ...
                <input
                  ...
                  disabled={!isEditing}
                  className={`w-full px-3 py-2 border rounded text-sm text-gray-700 transition-colors focus:outline-none ${isEditing ? 'border-aums-teal bg-white' : 'border-gray-200 bg-gray-50 opacity-80'}`}
                />
              </div>
            ))}
          </div>
        ...
        <div className="p-6">
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
            {[
              ...
              <div key={item.label} className="text-center p-3 border border-gray-100 rounded bg-gray-50 shadow-sm">
