            ...
            <div className="ml-auto">
              {!isEditing ? (
                <button
                  ...
                  className="px-4 py-1.5 text-xs font-semibold text-white rounded bg-aums-teal hover:bg-aums-teal-dark transition-colors"
                >
                  Edit Profile
                </button>
              ) : (
                <button
                  ...
                  className="px-4 py-1.5 text-xs font-semibold text-white rounded bg-aums-orange hover:bg-aums-orange-dark transition-colors"
                >
                  Save Changes
                </button>
              )}
            ...
            {[
              ...
              <div key={field.key}>
                ...
                <input
                  ...
                  disabled={!isEditing}
                  className={`w-full px-3 py-2 border border-gray-300 rounded text-sm text-gray-700 bg-gray-50 disabled:opacity-80 focus:outline-none ${isEditing ? 'focus:border-aums-teal' : ''}`}
                />
              </div>
            ))}
          </div>
